...
class GameListConfig extends Component {
      ...
      },
      {
        ...
        cell: (row) => (
          <Chip
            ...
            text={row.status?'Active':'Deactive'}
          />
        ),
      },
      // {
      ...
      let columns = [
        {
          ...
          selector: "img",
          minWidth: "150px",
          cell: (row) => <Link to={"game/"+row._id} ><img src={"static/"+row.image} height="100" alt={row.name} /></Link> ,
        },
        {
          name: "Name",
          selector: "name",
